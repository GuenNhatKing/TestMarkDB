"""
Django settings for TestMarkDB project.
...
if bool(env("DJANGO_READ_DOTENV")) and dotenv_path.exists():
...
# Use argon2: https://docs.djangoproject.com/en/5.2/topics/auth/passwords/
PASSWORD_HASHERS = [
